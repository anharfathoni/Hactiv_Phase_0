/* Encrypt me
    Kamu adalah seorang agen rahasia yang ingin mengirimkan pesan ke partnermu,
    untuk menmbuat kode yang kamu kirim tetap konfidental,
  ...
  Buatlah sebuah function yang mentranslate kata kata biasa, 
  menjadi kata kata ter enkripsi menggunakan kamus H8BI!
...
function encrypt(input) {
    ...
    var enkripsi = "!@#$%^&*()-+1234567890[]{}"
    var result = ""

    for (var i = 0; i < input.length; i++) {
        var checkbiasa = false
